        ...
        div { class: "row",
            ...
            div { class: "col-3", id: "colAutre",
                div { class: "col", id: "col2",
                    ...
                    div { class: "btn btn-outline-warning m-1", id: "btn5",
                        if sig_bagout().is_empty() {
                            " "
                        } else {
                            {sig_bagout}
                        }
...
#[component]
pub(crate) fn GeneratePDF()-> Element{
                        ...
                        div { class: "row",
                            div { class: "col mt-3",
                                if (sig_name.read().as_str() != String::new()) && (sig_name.read().as_str() != "...") {
                                    div {
                                        id: "text-archetype",
                                        class: "border text-bg-light p-3 rounded-2",
                                        {txt_base}
                                    }
                                }
                            }
