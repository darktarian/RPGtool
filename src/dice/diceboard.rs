...
use super::dice_custom::get_custom_dice;
...
pub(crate) fn DiceBoard() -> Element {
    ...
    rsx! {
        ...
        div { class: "row mb-1 mt-4",
            div { class: "col-5",
                input {
                    ...
                    oninput: move |event| {
                        sig_custom_dice.set(event.value());
                    },
                }
            }
            //dés custom
        ...
        div { class: "row mt-2",
            div { class: "col",
                div {
                    class: "bg-dark round rounded-2 p-3 text-light",
                    id: "result",
                    "{sig_result}"
                }
            }
                ...
                div {
                    ...
                    div { id: "collapseExample", class: "collapse",
                        div { style: "font-family: monospace; font-size: 0.9rem; line-height: 1.4;",
                            ...
                            div { "Parenthetical grouping: (2d6 + 2) * 2" }
                            br {}
